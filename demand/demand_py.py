...
### this file has hourly data for a year
...
profile = pd.read_csv(os.path.join(file_path, file_name), index_col="time")
...
def fixed(string, value):
    ...
    h = ver(h0, h1, h2, h3, h4, h5, h6, h7, h8, h9, h10, h11, h12, h13, h14, h15, h16, h17, h18, h19, h20, h21, h22, h23)
    data = hor(data,h)
